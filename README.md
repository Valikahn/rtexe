...
This script is for the installation of Apache, PHP, OpenSSL, rTorrent, ruTorrent and Webmin.  There is minimal sections that require human input, please continue reading to ensure you understand what is included in this program.
